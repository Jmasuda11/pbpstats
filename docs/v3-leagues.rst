...
corner/arc three-point labels require separate :doc:`v3-shot-zones` evidence.
Missing or conflicting evidence raises on lookup and dependent
``possession_start_type`` access; this does not prevent possession counts or
lineup/time accounting.
